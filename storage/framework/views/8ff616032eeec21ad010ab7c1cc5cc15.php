...
<header class="bg-white/90 backdrop-blur-md border-b border-slate-200 px-6 py-4 flex items-center justify-between sticky top-0 z-30">
    <div>
        <h1 class="text-2xl md:text-3xl font-bold text-slate-800"><?php echo e($pageTitle); ?></h1>
    ...
    <div class="flex items-center gap-4">
        ...
        <div class="flex items-center gap-3 rounded-2xl px-3 py-2 hover:bg-slate-50 transition">
            <img
                src="<?php echo e(asset('images/walter.png')); ?>"
                alt="Walter"
...
</header><?php /**PATH C:\Users\user\agency-site\resources\views/admin/partials/navbar.blade.php ENDPATH**/ ?>