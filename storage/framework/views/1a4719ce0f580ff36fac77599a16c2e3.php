...
<head>
    ...
    <meta property="og:image" content="<?php echo e(asset('images/JOSELINE1.png')); ?>" />
    ...
    <meta name="twitter:image" content="<?php echo e(asset('images/JOSELINE1.png')); ?>" />
   ...
   <?php echo $__env->make('partials.hero', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            <div class="grid items-start gap-12 lg:grid-cols-2">
                <div class="reveal">
                    ...
                    <div class="mt-8 img-soft">
                        <img class="h-80 w-full object-cover" src="<?php echo e(asset('images/companytable.png')); ?>" alt="Agency team photo" />
                    </div>
                </div>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-16 grid gap-6 sm:grid-cols-2 xl:grid-cols-4">
                <div class="dark-card-pro reveal text-center">
                    <img src="<?php echo e(asset('images/DMW.png')); ?>" alt="DMW License Verification" class="mx-auto mb-6 h-24 w-auto object-contain sm:h-28" />
                ...
                <div class="dark-card-pro reveal text-center" data-delay="100">
                    <img src="<?php echo e(asset('images/DOCUMENT.png')); ?>" alt="Documented Process" class="mx-auto mb-6 h-24 w-auto object-contain sm:h-28" />
                ...
                <div class="dark-card-pro reveal text-center" data-delay="200">
                    <img src="<?php echo e(asset('images/VERIFIEDY.png')); ?>" alt="Verified Job Matching" class="mx-auto mb-6 h-24 w-auto object-contain sm:h-28" />
                ...
                <div class="dark-card-pro reveal text-center" data-delay="300">
                    <img src="<?php echo e(asset('images/SUPPORT.png')); ?>" alt="Responsive Support" class="mx-auto mb-6 h-24 w-auto object-contain sm:h-28" />
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <div class="dark-card reveal">
                    <img class="mb-4 h-32 w-full rounded-2xl border border-brand-paper/10 object-cover" src="<?php echo e(asset('images/domestic.jpg')); ?>" alt="Domestic Helper Saudi" />
                ...
                <div class="dark-card reveal" data-delay="100">
                    <img class="mb-4 h-32 w-full rounded-2xl border border-brand-paper/10 object-cover" src="<?php echo e(asset('images/engineer.png')); ?>" alt="Skilled and professionals" />
                    <p class="text-xs font-semibold text-brand-paper/60">Saudi</p>
                ...
                <div class="dark-card reveal" data-delay="200">
                    <img class="mb-4 h-32 w-full rounded-2xl border border-brand-paper/10 object-cover" src="<?php echo e(asset('images/Constructionworker.jpeg')); ?>" alt="Skilled workers Greece" />
                ...
                <div class="dark-card reveal" data-delay="300">
                    <img class="mb-4 h-32 w-full rounded-2xl border border-brand-paper/10 object-cover" src="<?php echo e(asset('images/Skilled Professionals.jpg')); ?>" alt="Professionals Timor Leste" />
            ...
            <div id="jobsGrid" class="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                <article class="job-card reveal" tabindex="0" data-role="Female Nursing Specialist (Saudi)" data-category="saudi professional urgent">
                    <div class="job-media-wrap">
                        <img class="job-media" src="<?php echo e(asset('images/nursing.jpg')); ?>" alt="Female Nursing Specialist" />
                    </div>
                    <div class="p-6">
                        <div class="flex flex-wrap gap-2">
                ...
                <article class="job-card reveal" tabindex="0" data-role="Tile Worker / Tile Setter" data-category="greece skilled">
                    <div class="job-media-wrap">
                        <img class="job-media" src="<?php echo e(asset('images/Tile Worker.jpg')); ?>" alt="Tile Worker / Tile Setter" />
                    </div>
                    <div class="p-6">
                        <div class="flex flex-wrap gap-2">
                ...
                <article class="job-card reveal" tabindex="0" data-role="Building Electrician" data-category="saudi skilled urgent">
                    <div class="job-media-wrap">
                        <img class="job-media" src="<?php echo e(asset('images/Electrician.webp')); ?>" alt="Building Electrician" />
                    </div>
                    <div class="p-6">
                        <div class="flex flex-wrap gap-2">
                            <span class="job-tag">Saudi</span>
                ...
                <article class="job-card reveal" tabindex="0" data-role="IT Support Technician" data-category="saudi timor-leste professional">
                    <div class="job-media-wrap">
                        <img class="job-media" src="<?php echo e(asset('images/IT Support.jpg')); ?>" alt="IT Support Technician" />
                    </div>
                    <div class="p-6">
                        <div class="flex flex-wrap gap-2">
                ...
                <article class="job-card reveal" tabindex="0" data-role="Architectural Draftsman" data-category="timor-leste professional">
                    <div class="job-media-wrap">
                        <img class="job-media" src="<?php echo e(asset('images/Architectural Draftsman.webp')); ?>" alt="Architectural Draftsman" />
                    </div>
                    <div class="p-6">
                        <div class="flex flex-wrap gap-2">
                ...
                <article class="job-card reveal" tabindex="0" data-role="Purchase Representative" data-category="saudi professional">
                    <div class="job-media-wrap">
                        <img class="job-media" src="<?php echo e(asset('images/Purchase Representative.jpg')); ?>" alt="Purchase Representative" />
                    </div>
                    <div class="p-6">
                        <div class="flex flex-wrap gap-2">
                            <span class="job-tag">Saudi</span>
    ...
    <script>
        window.LaravelApp = {
            ...
            inquiryEndpoint: "<?php echo e(url('/api/inquiries')); ?>"
        };
    </script>
