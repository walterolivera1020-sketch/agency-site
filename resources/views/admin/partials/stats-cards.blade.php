<div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-8">
    <a href="{{ route('admin.dashboard') }}" class="bg-white rounded-3xl shadow-sm p-6 border border-slate-100 hover:shadow-md transition block">
        <p class="text-sm text-slate-500">Total Users</p>
        <h3 class="text-3xl font-bold text-slate-800 mt-2">1,245</h3>
        <p class="text-sm text-green-600 mt-2">+12% this month</p>
    </a>

    <a href="{{ route('admin.jobs.index') }}" class="bg-white rounded-3xl shadow-sm p-6 border border-slate-100 hover:shadow-md transition block">
    ...
    <a href="{{ route('admin.applications.index') }}" class="bg-white rounded-3xl shadow-sm p-6 border border-slate-100 hover:shadow-md transition block">
    ...
    <a href="{{ route('admin.inquiries.index') }}" class="bg-white rounded-3xl shadow-sm p-6 border border-slate-100 hover:shadow-md transition block">
