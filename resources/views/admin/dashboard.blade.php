    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
        <div class="xl:col-span-2 bg-white rounded-3xl shadow-sm p-6 border border-slate-100">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="{{ route('admin.applications.index') }}" class="text-sm text-indigo-600 font-semibold hover:underline">View All</a>
            </div>
        ...
        <div class="bg-white rounded-3xl shadow-sm p-6 border border-slate-100">
            ...
            <div class="space-y-3">
                <a href="{{ route('admin.jobs.index') }}" class="block w-full text-center bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-3 rounded-2xl font-semibold hover:opacity-95 transition">
                    Manage Jobs
                </a>

                <a href="{{ route('admin.applications.index') }}" class="block w-full text-center bg-slate-100 text-slate-800 py-3 rounded-2xl font-semibold hover:bg-slate-200 transition">
                    Manage Applicants
                </a>

                <a href="{{ route('admin.inquiries.index') }}" class="block w-full text-center bg-slate-100 text-slate-800 py-3 rounded-2xl font-semibold hover:bg-slate-200 transition">
                    View Inquiries
                </a>
            </div>
